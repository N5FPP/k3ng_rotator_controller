...
#define button_cw A3             // normally open button to ground for manual CW rotation
#define button_ccw A2            // normally open button to ground for manual CCW rotation
#define serial_led 3 //0             // LED blinks when command is received on serial port (set to 0 to disable)
...
#define button_stop A1            // connect to momentary switch (ground on button press) for preset stop (set to 0 to disable or for preset automatic start)
...
#define button_up A7               // normally open button to ground for manual up elevation
#define button_down A6             // normally open button to ground for manual down rotation
...
#define moon_tracking_button A9        // use with a normally open momentary switch to ground
...
#define sun_tracking_button A8        // use with a normally open momentary switch to ground
