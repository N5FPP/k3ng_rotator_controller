...
#define HARDWARE_N5FPP          // customize rotator_features_n5fpp.h, rotators_pins_n5fpp.h, rotator_settings_n5fpp.h
// #define HARDWARE_TEST         // customize rotator_features_test.h, rotators_pins_test.h, rotator_settings_test.h


// do not modify anything below this line

#if defined(HARDWARE_M0UPU) || defined(HARDWARE_EA4TX_ARS_USB) || defined(HARDWARE_WB6KCN) || defined(HARDWARE_N5FPP) || defined(HARDWARE_TEST)
...
// Serial port class definitions for various devices
  ...
  #define GPS_SERIAL_PORT_CLASS HardwareSerial
#else
