...
#define OPTION_SEND_STRING_OUT_CONTROL_PORT_WHEN_INITIALIZING_STRING ("N5FPP - K3NG Rotator Controller... Initializing...\n\r")

#define CONTROL_PORT0 1

// 8x21 character graphic display
#define GFX_WIDTH 128 // pixels
#define GFX_HEIGHT 64 // pixels
...
#define DEFAULT_LATITUDE 35.1583824      // Set these to your location to avoid waiting for GPS lock
#define DEFAULT_LONGITUDE -106.3110625
...
#define DISPLAY_DEGREES_STRING "\xF7"
